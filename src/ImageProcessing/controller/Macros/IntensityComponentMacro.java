 ...
 *
 */
public class IntensityComponentMacro extends AbstractComponentMacro {
  /**
   ...
   */
  public IntensityComponentMacro(String fileName, String outPutName)
  ...
  public void executeProcessingMacro(ImageProcessingModel model) {
    model.createRepresentation(VisualizationType.Intensity, fileName, outPutName);
  }
}
